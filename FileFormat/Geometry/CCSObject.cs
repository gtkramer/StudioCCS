...
public class CCSObject : CCSBaseObject
{
    ...
    public void SetParentClump(CCSClump _parentClump, int _nodeID)
    {
        ...
        if (ModelID != 0)
        {
            ...
            if (ChildModel != null)
            {
                ChildModel.SetClump(_parentClump, this);
            }
        }
        ...
        if (ShadowID != 0)
        {
            ...
            if (ShadowModel != null)
            {
                ShadowModel.SetClump(_parentClump, this);
            }
        }
    ...
    */
    ...
    public void DumpToSMD(StreamWriter outf, bool withNormals)
    {
        if (ChildModel != null)
        {
            ChildModel.DumpToSMD(outf, withNormals);
        }
    }
